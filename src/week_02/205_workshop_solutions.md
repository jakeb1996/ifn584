...
public class BankAccount
{
    ...
    {
        // Initialize fields with values. Balance is a numeric type and therefore defaults to zero.
    ...
    {
        // Add new funds. We really should check for negative amounts here, but it was not part of the specification.
        Balance += amount;
    }
...
```cs
var john = new BankAccount("123456", "John Doe");
var jane = new BankAccount("789012", "Jane Smith");

Console.WriteLine("Initial Account States:");
Console.WriteLine(john);
Console.WriteLine(jane);

// Need to deposit before transferring.
john.Deposit(500);
jane.Deposit(250);
...
Console.WriteLine("Transfer $150.00 from John to Jane:");
if (john.Transfer(jane, 150))
...
public class BankAccount
{
    ...
    {
        return $"Account Number: {AccountNumber}, Account Holder: {AccountHolderName}, Balance: {Balance:C}";
    }

    public bool Transfer(BankAccount targetAccount, decimal amount)
    {
        // Check if current account has sufficient balance
        if (Balance < amount)
            return false;
